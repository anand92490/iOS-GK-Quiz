...
class QuestionBank{
    var list = [Question]()
     ...
     init(){
        //1
         list.append(Question(image: "octopus", questionText: "How many hearts does an octopus have? ", choiceA: "2", choiceB: "3", choiceC: "1", choiceD: "0", answer: 2))
        //2
        ...
        //5
        list.append(Question(image: "singer", questionText: "Which singer's real name is Robyn Fenty?", choiceA: "Beyonce", choiceB: "Rihanna", choiceC: "Lady Gaga", choiceD: "Madonna", answer: 2))
        //6
        ...
        //10
         list.append(Question(image: "hashtag", questionText: "What is another name for hashtag?", choiceA: "Asterism", choiceB: "Circumflex", choiceC: "Pilcrow", choiceD: "Octothorpe", answer: 4))
